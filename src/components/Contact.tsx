...
function Contact() {
  ...
  return (
    <div id="contact" className="container mx-auto px-6 flex items-center justify-center min-h-screen scroll-mt-16">
      <motion.div
        ...
        <div className="text-center mb-8">
          ...
          >
            {contactStats.map((stat) => (
              <div
                key={stat.label}
                className="bg-white/60 dark:bg-slate-800/60 backdrop-blur-sm border border-white/20 dark:border-slate-700/50 rounded-xl p-4 shadow-lg"
              >
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="font-semibold text-slate-900 dark:text-slate-100">{stat.value}</p>
                  </div>
                </div>
              </div>
            ))}
